...
_BUILDERS = {
    ...
    ROLE_EPISODIC_MEMORIES: {
        "episode": (episode_iri, ("version", "user-id", "episode-id")),
        "memory": (memory_composite_iri, ("version", "user-id", "memory-id")),
    },
    ROLE_PROBLEM_TRACE: {
...
def iri_build_cmd(
    ...
    episode_id: Optional[str] = typer.Option(None, "--episode-id"),
