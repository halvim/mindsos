...
| [0073](../adr/0073-residents-descriptive.md) | Residents are descriptive; L3 contains no event loop | `start_resident` builds a `ResidentSubscription`; L4's event loop dispatches |
