...
| [0041](adr/0041-duplicate-capability-constants-parity-test.md) | [0138](adr/0138-kl-drops-write-api.md) | L2 redesign | KL lost its write API and every capability check with it; the duplicated-constant + parity-test pattern lives in L3 ([0078](adr/0078-l3-capability-local-copy.md)). Recorded 2026-09-16. |
| [0038](adr/0038-session-write-api.md) | [0138](adr/0138-kl-drops-write-api.md) | L2 redesign | Capability checks moved from the KL boundary to L3 invocation. Never built in this repo. The session still reaches KL via `writeable()` → `KLWriteHandle` ([0143](adr/0143-kl-write-handle-pattern.md)). Recorded 2026-09-19. |
| [0039](adr/0039-transitional-str-shim-deprecation.md) | [0138](adr/0138-kl-drops-write-api.md) | L2 redesign | The `str` shim for 0038's signature; nothing left to migrate once 0038's write API was gone. Never built in this repo. Recorded 2026-09-19. |
