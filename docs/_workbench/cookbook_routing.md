...
| `docs/usage/cookbook/nlu-slice.md` | **Scheduled — Phase 54** (`WSD_INSTALLATION_PHASE_MAP.md` §2 WSD-4, 2026-06-10) | **WSD_INSTALLATION_CHAT** | Phase 54 (lifecycle families + atomic v0-flip + end-to-end NLU scenario) | Phase 38 R0-PB-2 OOS'd this because no `nlu` builtins shipped at L3. WSD installation lands the relevant L3 family catalogs (per L1_L3_REFRAME_DECISIONS L3-36/L3-42/L3-43 family contracts). |
