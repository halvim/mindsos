...
4. ~~`MindsOSServer` class refactor~~ — **deferred** (CR-3 reversed; orchestrator stays free-function per PB-38; class + hooks land at the L4/L5 Local-write phase — design log §9). No `orchestrator.py` change.
