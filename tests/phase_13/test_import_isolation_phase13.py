"""Phase 13 — extends Phase 12 PB-18 import-isolation invariant.

``mindsos_knowledge`` (now including the new ``schemas`` sub-package)
imports nothing from ``mindsos_cli`` or ``mindsos_server`` (latter
doesn't exist yet — test parametrises over a "forbidden roots" list).
