...
MASTER_TSV     = "/sessions/exciting-pensive-rubin/mnt/Dulce - WordNet - FrameNet Mapping/release-v3/data/oewn-dulplus-master.tsv"
...
def main():
    ...
    audit_path = os.path.join(OUT_DIR, "phase5v3-audit-sample.tsv")
    ...
    disjoint_path = os.path.join(OUT_DIR, "phase5v3-disjoint-pairs.tsv")
    ...
    unrelated_path = os.path.join(OUT_DIR, "phase5v3-unrelated-pairs.tsv")
    ...
    with open(os.path.join(OUT_DIR, "phase5v3-stats.json"), "w") as f:
