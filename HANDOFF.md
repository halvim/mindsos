...
L2-34 + L2-35 backlog items closed at `docs/future_work/L2_FUTURE_WORK.md` + `docs/_workbench/STREAM_A_BACKLOG.md`. Phase 43 chat opens against `phase-39-confirmed`.
...
| Phase 44 chat (L0 substrate; Rail C) | **Requires `L0_SUBSTRATE_CHAT` closure first.** Then `confirmation_docs/POST_PHASE_38_PHASE_MAP.md §1 + §4 Phase 44 row`; `future_work/L0_FUTURE_WORK.md`; Chat B D-B14 + D-B16 + L2_CHAT_DECISIONS D-L2-23; this §2.3 + §3.1.7 |
...
| L0_SUBSTRATE_CHAT (Phase 44 gate) | `confirmation_docs/POST_PHASE_38_PHASE_MAP.md §1 + §6`; `future_work/L0_FUTURE_WORK.md`; `_workbench/L2_CHAT_DECISIONS.md` (D-L2-23); Chat B D-B2 + D-B14 + D-B16; this §2.3 + §3.1.7 |
...
| Code-skill installation chat | `_workbench/cookbook_routing.md` (owns `code-slice.md`); `future_work/L3_FUTURE_WORK.md` (L3-28/L3-30/L3-31); inherits WSD installation |
| Adapter family chat | `future_work/L3_FUTURE_WORK.md` (L3-49); inherits WSD installation |
...
| L4-v2 follow-up chat | **Opens after Phase 49 confirmed.** `future_work/L4_FUTURE_WORK.md`; this §3.1 + §3.1.5 |
